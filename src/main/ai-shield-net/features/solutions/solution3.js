    ...
    <div ref={ref} className="mx-auto mt-20 px-5 xl:px-0">
      <div className="w-full xl:w-7/12 flex flex-wrap lg:flex-nowrap justify-between items-start mx-auto gap-10">
        <div className="w-full lg:w-4/12 mx-auto">
          ...
          >
            The <b>Good</b> category marks safe URLs, the <b>Warning</b>{" "}
            category flags potentially dangerous ones, and the <b>Neutral</b>{" "}
            category indicates uncertainty, requiring further review.
          </p>
        </div>
        <div className="w-full lg:w-8/12 mx-auto">
          ...
          >
            <img
              src="/images/features/solutions/solution3.png"
              alt="solution2"
            />
          </div>
        </div>
...
export default FeaturesSolution3;
