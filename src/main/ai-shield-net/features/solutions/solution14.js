    ...
    <div ref={ref} className="mx-auto mt-20 px-5 xl:px-0 border-b border-gray-200 py-10">
      <div className="w-full xl:w-7/12 flex flex-wrap lg:flex-nowrap justify-between items-start mx-auto gap-10">
        <div className="w-full lg:w-4/12 mx-auto">
          ...
          >
            Manage agents enforcing anti-virus protection. <b>Enabled Agents</b>
            actively scan and remove threats, while <b>Disabled Agents</b> can
            be reactivated. This policy ensures continuous defense against
            evolving malware.
          </p>
        </div>
        <div className="w-full lg:w-8/12 mx-auto">
          ...
          >
            <img
              src="/images/features/solutions/solution14.png"
              alt="solution14"
            />
          </div>
        </div>
...
export default FeaturesSolution14;
