    ...
    <div ref={ref} className="mx-auto mt-20 px-5 xl:px-0 border-b border-gray-200 py-10">
      <div className="w-full xl:w-7/12 flex flex-wrap lg:flex-nowrap justify-between items-start mx-auto gap-10">
        <div className="w-full lg:w-8/12 mx-auto">
          ...
          >
            <img
              src="/images/features/solutions/solution4.png"
              alt="solution4"
            />
          </div>
        </div>
        <div className="w-full lg:w-4/12 mx-auto">
          ...
          >
            The <b>Whitelist</b> allows trusted URLs to bypass phishing detection. You can <b>add URLs</b> to prevent false flags or <b>remove them</b> if they’re no longer trusted.
          </p>
        </div>
      </div>
    </div>
...
export default FeaturesSolution4;
