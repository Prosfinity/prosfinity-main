    ...
    <div ref={ref} className="mx-auto mt-20 px-5 xl:px-0 border-b border-gray-200 py-10">
      <div className="w-full xl:w-7/12 flex flex-wrap lg:flex-nowrap justify-between items-start mx-auto gap-10">
        <div className="w-full lg:w-4/12 mx-auto">
          ...
          >
            Tracks AI-driven file analysis warnings with a <b>KPI Warning</b>, while <b>line and bar charts</b> visualize threat detection trends over time.
          </p>
        </div>
        <div className="w-full lg:w-8/12 mx-auto">
          ...
          >
            <img
              src="/images/features/solutions/solution5.png"
              alt="solution5"
            />
          </div>
        </div>
...
export default FeaturesSolution5;
