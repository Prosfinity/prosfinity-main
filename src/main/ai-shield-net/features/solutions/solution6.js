    ...
    <div ref={ref} className="mx-auto mt-20 px-5 xl:px-0">
      <div className="w-full xl:w-7/12 flex flex-wrap lg:flex-nowrap justify-between items-start mx-auto gap-10">
        <div className="w-full lg:w-8/12 mx-auto">
          ...
          >
            <img
              src="/images/features/solutions/solution6.png"
              alt="solution6"
            />
          </div>
        </div>
        <div className="w-full lg:w-4/12 mx-auto">
          ...
          >
            <b>Benign Files</b> are safe and require no action, while <b>Malware Files</b> pose risks and need immediate attention to prevent security threats.
          </p>
        </div>
      </div>
    </div>
...
export default FeaturesSolution6;
