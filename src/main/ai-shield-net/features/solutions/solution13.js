    ...
    <div ref={ref} className="mx-auto mt-20 px-5 xl:px-0">
      <div className="w-full xl:w-7/12 flex flex-wrap lg:flex-nowrap justify-between items-start mx-auto gap-10">
        <div className="w-full lg:w-8/12 mx-auto">
          ...
          >
            <img
              src="/images/features/solutions/solution13.png"
              alt="solution13"
            />
          </div>
        </div>
        <div className="w-full lg:w-4/12 mx-auto">
          ...
          >
            Manage agents analyzing executable file safety.{" "}
            <b>Enabled Agents</b> actively assess files, while{" "}
            <b>Disabled Agents</b> can be reactivated. This policy helps flag or
...
export default FeaturesSolution13;
