      ...
      <div className="w-full xl:w-7/12 flex flex-wrap lg:flex-nowrap justify-between items-start mx-auto gap-10">
        <div className="w-full lg:w-6/12 mx-auto">
          ...
          >
            ...
            AI-driven features that will continue to evolve as new threats
            emerge.
          </p>
        </div>
        <div className="w-full lg:w-6/12 mx-auto">
          ...
          >
            ...
            solution, AI ShieldNet reduces your overall cybersecurity expenses.
            But that’s not all – our product is built for the future. We’re
            constantly evolving and plan to add more cutting-edge AI Features to
