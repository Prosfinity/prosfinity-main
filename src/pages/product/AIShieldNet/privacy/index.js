  ...
  return (
    <div className="font-Poppins bg-white">
      <Head>
        ...
        <meta name="twitter:title" content="Prosfinity &#8211; AI ShieldNet Privacy Policy" />
        <meta
      ...
      <article>
        <div className="w-full xl:w-container px-8 lg:px-20 xl:px-0 mx-auto mt-16 xl:mt-16 pt-10">
          <div className="w-full">
            <p className="text-2xl md:text-3xl font-semibold leading-normal md:leading-relaxed pt-10">
              General Information
            </p>
