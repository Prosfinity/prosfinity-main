        ...
        <div className="w-full xl:w-container px-8 lg:px-20 xl:px-0 mx-auto mt-16 xl:mt-16 pt-10">
          <div className="w-full">
            ...
            <p className="mt-5 text-sm md:text-base font-light leading-5">
              ...
              Licensee must provide a valid tenant-scoped Installation Token
              generated by the Prosfinity Portal. The token is used only to
              enrol the endpoint and is not retained by the installed agent.
              This step confirms that installation is authorized for the
